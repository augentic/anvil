...
| **5** | **Stale meta-docs** (this file's predecessor, `skills-test-coverage.md`, `decision-log.md`) | S | Med | Counts and paths disagree with the live tree; misleads the next optimizer. |
