...
- **`ExampleClaim` / `AuthorityClass` scaffolds** — zero external callers but RFC-27 evidence/authority shapes; YAGNI deletion risks re-adding typed claim surfaces when `code-runtime` extract lands.
