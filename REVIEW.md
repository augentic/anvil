...
| `specify/evals/scenarios/pure-intent.md:59` + `evals/shared/assertions.md:8` | Links to deleted `rfcs/rfc-42-acceptance.md` / `rfc-43-release-proving.md` | Archive those RFCs or rewrite self-contained |
