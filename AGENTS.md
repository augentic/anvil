...
| Concern | Where |
| ------- | ----- |
| Materialize CLI + export conventions | `specify extension run vectis -- materialize assets` — codified in [`specify-cli` `wasi-tools/vectis/DECISIONS.md` §K](https://github.com/augentic/specify-cli/blob/main/wasi-tools/vectis/DECISIONS.md#k--materialization-and-render-by-kind) |
