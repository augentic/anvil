...
operator directive — winner). Documentation states the same 30-minute
expiry; observed behaviour expires sessions after 15 minutes
(`mock-code`) — intent outranks both.
