...
Static fixture covering the degenerate N=1 path for the [`intent` source adapter](../../../../sources/intent/adapter.yaml). The fixture is shape-only: it pins the inputs `/spec:plan` and `/spec:refine` pass to the [`enumerate`](../../../../sources/intent/briefs/enumerate.md) and [`extract`](../../../../sources/intent/briefs/extract.md) briefs, and the outputs those briefs must emit.
