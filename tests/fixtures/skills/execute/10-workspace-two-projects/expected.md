...
- CWD save/restore brackets every iteration: `specrun plan next` and `specrun plan transition` always resolve against the workspace root's `plan.yaml`, never against a slot's.
