...
Pins the merge-conflict stop hint contract from [`plugins/spec/skills/merge/SKILL.md`](../../../../../plugins/spec/skills/merge/SKILL.md) §Stop hint contract. Stress-tests the merge-baseline-conflict branch of RFC-25 §Execution model trigger table.
