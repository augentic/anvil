...
**Stress-tests:** Synthesis end-to-end: serial `extract` per source; two-entry `Evidence[]`; `Sources:` line carrying both keys; `id` correlation produces deterministic reconciliation; lifecycle reaches `refined` cleanly when sources agree.
