...
For the report's structural shape and exit semantics, see [`report-shape`](report-shape.md). For reviewer-facing rule prose that cites this vocabulary, see [`IFACE-005 Consumer Impact Classification`](../codex/consumer-impact-classification.md).
...
- [`IFACE-005 Consumer Impact Classification`](../codex/consumer-impact-classification.md) — stable codex rule for reviewer and compatibility findings.
