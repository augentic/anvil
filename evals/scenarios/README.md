...
| Cross-repo contract flow (full lifecycle) | [`cross-repo-contract-flow`](cross-repo-contract-flow.md) | parked | full |
...
| Step-through breakout mid-execute | [`stepthrough-breakout`](stepthrough-breakout.md) | parked | full |
...
| Workspace breakout after build failure | [`workspace-breakout`](workspace-breakout.md) | parked | full |
| Stale-workspace recovery | [`stale-workspace-recovery`](stale-workspace-recovery.md) | parked | full |
