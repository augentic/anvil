...
- **Sandbox:** `evals/.sandbox/execute-fail-resume/` (recreated fresh 2026-06-14)
...
- **Key paths:** `plan.yaml`, `change.md`, `discovery.md`, `crates/session_cookie_harden/`, `.specify/archive/`, `.specify/journal.jsonl`, `drive_eval.py`
