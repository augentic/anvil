...
The `cli`-side acceptance harness (`specify source resolve intent` plus the synthesis runner once core synthesis lands) is the executable surface that consumes this fixture. From this repository, the fixture is read-only documentation of the contract.
