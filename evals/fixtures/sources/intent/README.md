...
Static fixture covering the degenerate N=1 path for the [`intent` source adapter](../../../../adapters/sources/intent/adapter.yaml). The fixture is shape-only: it pins the inputs `/spec:plan` and `/spec:refine` pass to the [`survey`](../../../../adapters/sources/intent/prose/briefs/survey.md) and [`extract`](../../../../adapters/sources/intent/prose/briefs/extract.md) briefs, and the outputs those briefs must emit.
