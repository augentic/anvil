//! Integration tests for `workflow::registry::registry` and
//! `workflow::registry::validate`.
//!
...
use workflow::registry::{ContractRoles, GreenfieldSeed, Registry, RegistryProject};
