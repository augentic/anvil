...
pub(crate) use plan::core::{
    ...
    authority_override, build_request, claim_next, drained_line, entry_mut, finding,
    orphan_authority_override_keys, plan_status_body, reject_duplicate_source_keys, resolve_target,
    resolve_topology, scaffold, unknown_slice_err,
};
