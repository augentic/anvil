    ...
    P: Provider + Anchor + Model + Resolver + SourceSeam + TargetSeam,
{
    ...
    Router::new(invoker)
        ...
        .route("/source/{source}/survey", post!(workflow::orchestrate::handlers::Survey))
        .route("/source/{source}/extract", post!(workflow::orchestrate::handlers::Extract))
        ...
        .route("/slice/{name}/refine", post!(workflow::orchestrate::handlers::Refine))
        .route("/slice/{name}/build", post!(workflow::orchestrate::handlers::Build))
        .route("/slice/{name}/merge", post!(workflow::orchestrate::handlers::MergeRun))
        ...
        .route("/plan/{name}/author", post!(workflow::orchestrate::handlers::Author))
        .route("/plan/execute", post!(workflow::orchestrate::handlers::Execute))
