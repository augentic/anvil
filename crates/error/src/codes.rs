...
pub const WIRE_CODES: &[&str] = &[
    ...
    "adapter-describe-failed",
    "adapter-describe-unavailable",
    ...
    "adapter-prefetch-unpinned",
    "adapter-store-failed",
