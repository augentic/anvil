...
pub enum RulesAction {
    ...
    /// `adapters/codex/rules/universal/` tree, or the distributed
    ...
    ///
    /// Mirrors `adapters/codex/rules/universal/` (and, with
...
pub struct SyncArgs {
    ...
    /// (`adapters/codex/rules/core/`) alongside the always-distributed
...
pub struct ExportArgs {
    ...
    /// `adapters/codex/rules/universal/` tree, then the distributed
