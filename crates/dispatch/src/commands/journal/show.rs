...
//! [`specify_workflow_lib::journal::show`]; this handler only renders.

use std::io::Write;

use serde::Serialize;
use specify_error::Result;
use specify_workflow_lib::journal::{self, Event};
...
/// # Errors
///
/// Propagates journal-read and envelope-render failures.
