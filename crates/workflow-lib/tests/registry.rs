//! Integration tests for `workflow_lib::registry::registry` and
//! `workflow_lib::registry::validate`.
//!
...
use workflow_lib::registry::{ContractRoles, GreenfieldSeed, Registry, RegistryProject};
