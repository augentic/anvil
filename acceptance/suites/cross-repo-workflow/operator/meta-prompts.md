...
- Scenario stub: acceptance/suites/cross-repo-workflow/queue/<scenario-id>.md
- Shared script: acceptance/suites/cross-repo-workflow/scenario.md (Workspace, Prerequisites, Inputs,
...
- Scenario stub + acceptance/suites/cross-repo-workflow/scenario.md (Invocation, Assertions, Negative
  Expectations).
- acceptance/suites/cross-repo-workflow/operator/run-summary-template.md field-set.
