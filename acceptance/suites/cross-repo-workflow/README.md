...
`acceptance/suites/cross-repo-workflow/` because the cross-repo workflow spans the workspace, registry,
...
[`operator/RUNNING.md`](operator/RUNNING.md). The reusable operator prompts live in
[`operator/meta-prompts.md`](operator/meta-prompts.md).
...
7. Fill out [`operator/run-summary-template.md`](operator/run-summary-template.md).

## Run Summary

Every manual run should produce a summary using
[`operator/run-summary-template.md`](operator/run-summary-template.md). Keep the completed summary
