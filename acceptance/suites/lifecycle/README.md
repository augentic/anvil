...
| Combined evidence (code + docs) | [`05a-combined-evidence/`](05a-combined-evidence/scenario.md) | pending |
| `[divergence]` from authority resolution | [`05b-divergence-authority/`](05b-divergence-authority/scenario.md) | pending |
| `[conflict]` from same-authority disagreement | [`05c-same-authority-conflict/`](05c-same-authority-conflict/scenario.md) | pending |
| Cross-source propose-time merge | [`05e-cross-source-merge/`](05e-cross-source-merge/scenario.md) | pending |
| Multi-repo assignment from a workspace | [`06-multi-repo-workspace/`](06-multi-repo-workspace/scenario.md) | pending |
| Operator amends one-slice plan into two | [`07-amend-into-two/`](07-amend-into-two/scenario.md) | pending |
| Single-project plan generation | [`plan-single-project/`](plan-single-project/scenario.md) | pending |
| Contract routing plan generation | [`contract-routing/`](contract-routing/scenario.md) | pending |
...
| Scenario | Directory | Status |
| --- | --- | --- |
| Extract failure | [`05f-extract-failure/`](05f-extract-failure/scenario.md) | pending |
| Invalid Evidence schema rejection | [`05g-invalid-evidence/`](05g-invalid-evidence/scenario.md) | pending |
| Target `shape` injection | [`05h-target-shape-injection/`](05h-target-shape-injection/scenario.md) | pending |
| Source-adapter sandbox path-denied | [`05j-source-sandbox-denied/`](05j-source-sandbox-denied/scenario.md) | pending |
...
The **release gate is green** when `tests/fan_in_fan_out.rs` passes under `cargo make test`, `pure-intent` is `passed`, and every non-deferred entry is `passed`. When the whole catalog is `passed` (or `deferred` with sign-off), record the gate as green here and flip RM-05 from *Partial* to *Done* in [`rfcs/roadmap.md`](../../../rfcs/roadmap.md).
