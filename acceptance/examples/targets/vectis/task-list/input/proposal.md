...
Manual (this fixture's `Sources:` lines are stand-ins for real plan-resolved bindings — the matching source-side fixture lives at `acceptance/examples/sources/screenshots/task-list-two-screen/`).
