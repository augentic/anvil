...
1. **Save CWD.** The initiating directory is the workspace; `specify plan status`, `specify plan next`, `specify plan transition`, and the plan lock all live there. Restore to it at the end of the iteration.
