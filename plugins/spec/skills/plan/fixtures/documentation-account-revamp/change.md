...
Scaffolded by `/spec:plan account-revamp source docs=./design-notes/account`. No tentative merges; no likely divergences. Operator reviews and stamps Gate 1 with `specify plan transition account-revamp reviewed`.
