...
### checkout
Source: legacy (src/payments.rs)
Description: Completes payment for a cart.
Depends-on hints: cart-management

### payment-intent
Source: legacy (src/payments.rs)
Description: Creates a payment authorisation against the gateway.
Depends-on hints: checkout
