...
|---|---|---|
| [`intent-fix-typo/`](intent-fix-typo/) | #1 | Pure-intent N=1: `change.md` minimal, `plan.yaml` with one structured `{ source-key, lead-id }` binding under the auto-bound project, three-section `discovery.md`. |
