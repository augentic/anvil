...
license: MIT
allowed-tools: Read, Glob, Grep, Shell, SemanticSearch, WebFetch, WebSearch
...
Read `schema.yaml` to understand what artifacts the schema defines, what source types are supported (Source-code, Manual), and what the workflow looks like.
