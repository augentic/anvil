...
- Canonical "stop, don't patch" example: Vectis [Template / version-pin drift handling](https://github.com/augentic/specify-adapters/blob/main/targets/vectis/prose/briefs/build.md#template--version-pin-drift-handling) (`adapters/targets/vectis/prose/briefs/build.md` in consumer projects).
