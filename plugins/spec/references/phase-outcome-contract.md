...
Durable run telemetry lives at `.specify/journal.jsonl` (RFC-25 [Observability](https://github.com/augentic/specify/blob/main/rfcs/done/rfc-25-workflow.md#observability-rfc-19)). Phase skills append structured JSON lines there; `/spec:execute` does not read the journal as a signalling channel.
