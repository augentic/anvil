...
| [execute](skills/execute/SKILL.md) | `/spec:execute` | Confirm Gate 1, then drive the drained per-slice loop (`specify plan approve` + `specify plan execute`) |
