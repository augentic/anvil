...
- **[Capture output format](https://github.com/augentic/specify-adapters/blob/main/sources/captures/references/capture-format.md)** — directory layout wiretap output must satisfy for `captures` source binding (`tests/data/replays/<handler>/<scenario>.json`).
