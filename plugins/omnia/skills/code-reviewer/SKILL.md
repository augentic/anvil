...
After all specialists report, the lead reads `references/review-checks.md` and applies checks UNI-001 through UNI-021 with Omnia/WASM-specific detection. Several universal checks overlap with categories already assigned to the specialists. Skip those and focus on the gaps:
...
- [Review Checks](references/review-checks.md) -- Language and domain-agnostic review checklist shared across all reviewer skills
