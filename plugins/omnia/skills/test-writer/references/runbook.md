...
Operational detail for `omnia-test-writer`. The SKILL.md keeps only the orientation surface (Critical Path + Reference table + Guardrails); everything procedural lives here.
...
1. [mock-provider.md](mock-provider.md) -- Static and Replay MockProvider patterns
2. [spec-to-test-mapping.md](spec-to-test-mapping.md) -- How spec scenarios map to test functions
...
1. **SKILL.md** -- test generation rules
...
See [spec-to-test-mapping.md](spec-to-test-mapping.md) for the detailed mapping rules.
...
See [mock-provider.md](mock-provider.md) for complete patterns (Static and Replay variants).
...
See [spec-to-test-mapping.md](spec-to-test-mapping.md) for the mapping rules that enable this.
