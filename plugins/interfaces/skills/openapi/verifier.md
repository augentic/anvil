...
|---|---|---|---|---|
| `single` (default) | contracts brief in `/spec:define` | Post-author or post-import | One change's `contracts/http/` inside one project | Markdown report for the verify-repair loop |
