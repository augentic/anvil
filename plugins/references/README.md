...
- **`review-checks.md`**: Transitional pointer to the universal review codex under `capabilities/default/codex/`. Referenced by existing reviewer skills until they are updated to read codex rules directly.
