...
- **`universal-checks.md`**: Language and domain-agnostic review checklist (UNI-001 through UNI-021). Referenced by all reviewer skills (`code-reviewer`, `core-reviewer`, `ios-reviewer`, `android-reviewer`).
- **`reviewer-workflow.md`**: Shared orchestration for reviewer skills -- review-fix cycle, synthesis protocol, design-level findings delegation, and common verification checklist items. Referenced by `core-reviewer`, `ios-reviewer`, and `android-reviewer`.
