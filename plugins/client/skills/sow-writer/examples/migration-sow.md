...
A TypeScript notification processing service is being migrated to Rust WASM. The `/spec:extract` skill has produced Specify artifacts (specs + design.md), and we need to generate a SoW for the client.
