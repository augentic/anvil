...
| [execute](skills/execute/SKILL.md) | `/emery:execute` | Confirm Gate 1, then drive the drained per-slice loop (`emery plan approve` + `emery plan execute`) |
