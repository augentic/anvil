...
Fixture capture and regression testing for migration workflows. Source-code analysis lives in `/spec:extract`; cloning a source tree is an inlined guarded `git clone` snippet at the callers — see the *Cloning a source tree* subsection in [`plugins/spec/skills/analyze/SKILL.md`](../spec/skills/analyze/SKILL.md) (or [`plugins/rt/skills/wiretapper/SKILL.md`](skills/wiretapper/SKILL.md) for legacy-repo bootstrap).
