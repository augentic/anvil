...
- On-disk shape of capability summaries matches the [`analyze/SKILL.md` §Output contract](../../../../../../analyze/SKILL.md): `### <name>` heading plus fenced YAML block, fixed field order (`summary`, `sources`, `depends-on`, `hints`, `confidence`).
