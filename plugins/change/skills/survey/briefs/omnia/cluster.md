...
Input: a small TypeScript monolith under [`inputs/monolith/`](../../../draft/briefs/omnia/fixtures/analyze/legacy-code/inputs/monolith/) with four inferable capabilities spanning `src/users`, `src/auth`, `src/common`, and `src/billing`.
