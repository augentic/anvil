...
The three capabilities were chosen to exercise the specific clustering heuristics pinned in [`plugins/change/skills/plan/briefs/omnia/analyze.md` §*Legacy-code branch*](../../../briefs/omnia/analyze.md):
