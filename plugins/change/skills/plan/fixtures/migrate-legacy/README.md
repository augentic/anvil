...
- **No retired CLI verbs.** Every shell-out in [`transcript.md`](transcript.md) uses the post-Phase-3 surface (`specify change create`, `specify change plan {create, add, amend, validate}`, `specify slice outcome show`, `specify slice journal append`).
