Pins the RFC-3a §"When are registry.yaml and change.md required?" readiness-gate widening: /change:plan is valid with no CLI inputs when change.md:inputs is non-empty.
