...
- Open questions from discovery answered inline:
  ...
  - *Do we ship the Android `vectis-design` library as a sibling module or a published artifact?* — sibling module in the counter app's Gradle build for this change; a standalone publication is deferred.
