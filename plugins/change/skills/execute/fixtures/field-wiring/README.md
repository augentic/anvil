...
- End-to-end coverage of these signals across a multi-change plan lives in `../e2e-platform-v2/`; that meta-fixture exercises the same argument-resolution code path on every entry of RFC-2 §"The Plan".
