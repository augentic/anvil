---
id: merge
description: Merge the contract slice into the repository
needs: [build]
---
...
The JSON envelope is the canonical shape callers parse. Field reference (matches the verifier siblings' [`cross-project` mode](../../../plugins/contract/skills/openapi/verifier.md#cross-project-mode)):
