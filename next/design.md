...
This repo (`oik`) is the hub. It's the control plane for spec-driven development across the platform.
...
## What Changes From the Current Schema

| Component           | Change needed                                              |
| ------------------- | ---------------------------------------------------------- |
| `registry.toml`     | **New file.** Add to repo root.                            |
| `specs/`            | **New directory.** Add `specs/<repo>/<capability>/spec.md` |
| `config.yaml`       | Update context to mention registry and multi-repo          |
| `schemas/schema.yaml` | No change -- the 6-artifact DAG works as-is             |
| `templates/proposal.md` | Add: "Read registry.toml for platform topology"        |
| `templates/specs.md` | Add: "Namespace delta specs under repo name"              |
| `templates/manifest.md` | Add: "Include repo name in each target"                |
| `templates/pipeline.md` | Add: "Include repo + repo_url fields per target"       |
| `templates/current-state.md` | Add: "Analyse crates across repos per registry"  |
| `templates/design.md` | Minor: mention cross-repo contracts                      |

No new artifacts. No new commands. No new tooling.
