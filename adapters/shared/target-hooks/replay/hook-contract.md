...
- [`../../../targets/omnia/briefs/build/replay.md`](https://github.com/augentic/specify-adapters/blob/main/targets/omnia/prose/briefs/build/replay.md) — Omnia runner (reference implementation)
