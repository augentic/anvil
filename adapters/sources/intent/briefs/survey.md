...
- The single lead becomes the slice driving the plan; see [From sources to slices](../../../../docs/explanation/reconciliation.md#plan-time-leads-become-slices) for how leads reconcile into slices.
