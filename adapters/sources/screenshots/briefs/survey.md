...
A full input / output fixture for this example lives at [`acceptance/fixtures/sources/screenshots/task-list-two-screen/`](../../../../acceptance/fixtures/sources/screenshots/task-list-two-screen/) in the repo.
