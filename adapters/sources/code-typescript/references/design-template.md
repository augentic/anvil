...
Step 7 writes the spec and design.md artifacts to `$SLICE_DIR` using the format specified in [augentic-specify-usage.md](../../../../docs/explanation/augentic-specify-usage.md). The artifact format follows the `augentic` schema from [augentic/lifecycle](https://github.com/augentic/lifecycle).
...
Write `$DESIGN_PATH` with the following sections (see [augentic-specify-usage.md](../../../../docs/explanation/augentic-specify-usage.md) Design Document Format for the full template):
...
See [augentic-specify-usage.md](../../../../docs/explanation/augentic-specify-usage.md) Spec File Format and Deriving Specs from Source Code for the complete template.
