...
Before completing, verify all items from the [Specify Artifact Validation Checklist](../../../../plugins/references/specify.md#validation-checklists) are satisfied, plus the skill-specific checklist below.
