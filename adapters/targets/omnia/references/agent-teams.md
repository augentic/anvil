...
4. **Pattern compliance**: Fix follows established patterns in the Omnia target build brief's verify-repair section (see [`adapters/targets/omnia/briefs/build.md`](../briefs/build.md) § Verify-repair loop)
