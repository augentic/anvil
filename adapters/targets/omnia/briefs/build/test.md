...
1. **Load artifacts and references** — `spec.md`, `design.md`, [`providers/`](../../references/providers/) for the trait-specific MockProvider patterns, [`mock-provider.md`](../../references/mock-provider.md) for Static + Replay variants, and the slice's `tests/data/` fixtures if any.
