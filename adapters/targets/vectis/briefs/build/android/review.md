...
Carries the body of the retired `vectis-android-reviewer` skill. The Android-specific team-spawn protocol lives in [`review/team-protocol-android.md`](../../../../../plugins/vectis/references/review/team-protocol-android.md).

## Pipeline

1. **Verify prerequisites** — Android verify succeeded; ktlint / detekt are available.
2. **Spawn specialists concurrently** with the verbatim prompts in [`review/team-protocol-android.md`](../../../../../plugins/vectis/references/review/team-protocol-android.md):
   - **Structural** — AND-001..027: screen / ViewModel correspondence, effect handlers, token usage, UniFFI library override, generated-type imports, coroutine safety, recurring-group component candidates. Full library: [`review/android-checks.md`](../../../../../plugins/vectis/references/review/android-checks.md).
   - **Quality** — KTL-001..010: force-unwraps, debug output, coroutine cancellation, Compose state, previews, a11y `contentDescription`. Full library: [`review/kotlin-quality-checks.md`](../../../../../plugins/vectis/references/review/kotlin-quality-checks.md).
   - **Integration** — only on the first full-scope iteration. Token / asset / composition cross-artifact checks per [`review/team-protocol-android.md`](../../../../../plugins/vectis/references/review/team-protocol-android.md) § Integration.
3. **Universal checks (lead).** Apply UNI-001..021 from the default codex with Kotlin / Android heuristics. Full library: [`review/universal-checks.md`](../../../../../plugins/vectis/references/review/universal-checks.md).
...
- Stable codex citations: `rule_id: VECTIS-AND-001` (for example) appears alongside each mapped finding. Codex rules: [`targets/vectis/codex/`](../../../codex/).
