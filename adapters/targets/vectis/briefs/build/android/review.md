...
3. **Universal checks (lead).** Apply every `UNI-*` rule from [`adapters/targets/codex/`](../../../../codex/) with Kotlin / Android heuristics. Full library: [`review/universal-checks.md`](../../../references/review/universal-checks.md).
