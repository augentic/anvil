...
3. **Universal checks (lead).** Apply every `UNI-*` rule from [`adapters/targets/codex/`](../../../../codex/) with Rust / Crux heuristics. Full library: [`review/universal-checks.md`](../../../references/review/universal-checks.md). Skip universal checks already covered by the specialists per the dedupe table in [`review/team-protocol-core.md`](../../../references/review/team-protocol-core.md).
