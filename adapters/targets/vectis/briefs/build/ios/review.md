...
3. **Universal checks (lead).** Apply UNI-001..021 from the default codex with Swift heuristics. Full library: [`review/universal-checks.md`](../../../references/review/universal-checks.md).
