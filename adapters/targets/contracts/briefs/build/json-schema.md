...
|---|---|---|
| Author or extend reusable schemas from a spec | build brief during `/spec:build`; operator extending the baseline for new payload types | [`../../references/json-schema/author.md`](../../references/json-schema/author.md) |
