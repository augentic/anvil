...
| [`component-meta.schema.json`](component-meta.schema.json) | Validates the component mirror's provenance stamp at `components/component-meta.yaml` in the out-of-tree per-project cache (the structural twin of `codex/codex-meta.yaml`). |
