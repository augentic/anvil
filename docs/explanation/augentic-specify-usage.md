...
> [!NOTE]
> This is a repository-specific supplement, not part of the core Specify contract. It explains how Augentic's specialist skills (Omnia, Vectis, and friends) *consume* the standard artifacts. For the artifacts themselves, start with [Artifacts in depth](artifacts.md) and the [Artifact format](../reference/artifact-format.md) reference — this page does not restate them.
