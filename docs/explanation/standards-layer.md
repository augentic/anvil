...
Running `emery plan execute` is operator approval of a *plan*, not engineering-standards enforcement. Build-time judgment (`REVIEW.md`, `build/review.md` briefs) is a separate surface.
