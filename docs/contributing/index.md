...
The two repos are independently versioned and released. Skills invoke the CLI as a subprocess (`specify change create ...`, `specify validate ...`, etc.) and consume its JSON output. They never import Rust code directly.
