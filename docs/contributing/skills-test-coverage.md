...
| `specify-extract` (logic lives in per-source `extract` briefs invoked by `/spec:refine`) | `<source-path> <slice-dir>` (a sub-step of `/spec:refine`) | -- | [`source.md`](../../adapters/targets/contracts/tests/source.md), [`acceptance/fixtures/sources/{intent,documentation,typescript,screenshots}/`](../../acceptance/fixtures/sources/) | ✓ | The `contracts-source` scenario asserts artifacts derived from source code; source fixtures preserve representative Evidence goldens for future executable replay. |
