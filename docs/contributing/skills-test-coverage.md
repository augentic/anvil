...
[`acceptance/suites/cross-repo-workflow/`](../../acceptance/suites/cross-repo-workflow/) and
[`acceptance/suites/plan-authoring/`](../../acceptance/suites/plan-authoring/) cover the LLM-driven body bytes that the
...
- **Skills:** every `plugins/<plugin>/skills/<skill>/SKILL.md` and the
  ...
  trigger).
- **Plan-generation scenarios:** [`acceptance/suites/plan-authoring/`](../../acceptance/suites/plan-authoring/) -- two
  manual scenarios that cover plan authoring only (no execution, no push, no
  finalize).
- **Cross-repo scenarios:** [`acceptance/suites/cross-repo-workflow/`](../../acceptance/suites/cross-repo-workflow/) --
...
- **Primary trigger** -- the `argument-hint` from the skill's frontmatter, or
  ...
  `argument-hint`.
- **Plan trace(s)** -- markdown scenarios under `acceptance/suites/plan-authoring/` or
  `acceptance/suites/cross-repo-workflow/` that exercise this skill (directly or as a documented
...
| --- | --- | --- | --- | --- | --- |
| [`specify-execute`](../../plugins/spec/skills/execute/SKILL.md) | `/spec:execute` (no argument-hint; loop semantics documented in body) | [`acceptance/suites/cross-repo-workflow/scenario.md`](../../acceptance/suites/cross-repo-workflow/scenario.md) (`execute-loop-all-done`) | [`acceptance/examples/skills/execute/*/`](../../acceptance/examples/skills/execute/) | ✓ | Cross-repo scenario asserts the loop terminates; fixture docs preserve `input/plan.yaml` + `expected.md` examples for breakout, build-failure, and workspace cases. |
| [`specify-plan`](../../plugins/spec/skills/plan/SKILL.md) | `<change-name>` | [`acceptance/suites/plan-authoring/single-project/scenario.md`](../../acceptance/suites/plan-authoring/single-project/scenario.md), [`acceptance/suites/plan-authoring/contract-routing/scenario.md`](../../acceptance/suites/plan-authoring/contract-routing/scenario.md), [`acceptance/suites/cross-repo-workflow/scenario.md`](../../acceptance/suites/cross-repo-workflow/scenario.md) | -- | ✓ | Single-project covers local-only plans; contract-routing covers cross-repo plan authoring; cross-repo/scenario.md drives the full plan → execute → finalize path. |
...
| [`specify-init`](../../plugins/spec/skills/init/SKILL.md) | `<target>` (or `workspace`) | [`acceptance/suites/plan-authoring/single-project/scenario.md`](../../acceptance/suites/plan-authoring/single-project/scenario.md), [`acceptance/suites/plan-authoring/contract-routing/scenario.md`](../../acceptance/suites/plan-authoring/contract-routing/scenario.md), [`acceptance/suites/cross-repo-workflow/scenario.md`](../../acceptance/suites/cross-repo-workflow/scenario.md) | -- | ✓ | Single-project covers `specify init <target>`; contract-routing and cross-repo cover both `--workspace` and target-bound init. |
| [`specify-merge`](../../plugins/spec/skills/merge/SKILL.md) | `[slice-name]` | [`acceptance/suites/cross-repo-workflow/scenario.md`](../../acceptance/suites/cross-repo-workflow/scenario.md) | [`describe.md`](../../adapters/targets/contracts/tests/describe.md), [`design.md`](../../adapters/targets/contracts/tests/design.md), [`update.md`](../../adapters/targets/contracts/tests/update.md), [`import.md`](../../adapters/targets/contracts/tests/import.md), [`source.md`](../../adapters/targets/contracts/tests/source.md), [`acceptance/examples/skills/merge/`](../../acceptance/examples/skills/merge/) | partial | Reached through `stages: [refine, build, merge]`; fixture docs preserve `success` and `conflict-replay` shapes. No scenario targets merge in isolation against a live LLM body. |
...
- Acknowledge that `tests/scenarios/*.json` does not exist; the brief should
  call out `acceptance/suites/plan-authoring/**/scenario.md`, `acceptance/suites/cross-repo-workflow/scenario.md`, and
