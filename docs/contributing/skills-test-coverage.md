...
| [`specify-init`](../../plugins/spec/skills/init/SKILL.md) | `<target>` (or `workspace`) | [`tests/plan/single-project.md`](../../tests/plan/single-project.md), [`tests/plan/contract-routing.md`](../../tests/plan/contract-routing.md), [`tests/cross-repo/scenario.md`](../../tests/cross-repo/scenario.md) | -- | ✓ | Single-project covers `specify init <target>`; contract-routing and cross-repo cover both `--workspace` and target-bound init. |
