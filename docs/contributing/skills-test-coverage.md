...
[`acceptance/lifecycle/`](../../acceptance/lifecycle/) and
[`acceptance/lifecycle/`](../../acceptance/lifecycle/) cover the LLM-driven body bytes that the
...
- **Skills:** every `plugins/<plugin>/skills/<skill>/SKILL.md` and the
  ...
  trigger).
- **Plan-generation scenarios:** [`acceptance/lifecycle/`](../../acceptance/lifecycle/) -- two
  manual scenarios that cover plan authoring only (no execution, no push, no
  finalize).
- **Cross-repo scenarios:** [`acceptance/lifecycle/`](../../acceptance/lifecycle/) --
...
- **Primary trigger** -- the `argument-hint` from the skill's frontmatter, or
  ...
  `argument-hint`.
- **Plan trace(s)** -- markdown scenarios under `acceptance/lifecycle/` or
  `acceptance/lifecycle/` that exercise this skill (directly or as a documented
...
| --- | --- | --- | --- | --- | --- |
| [`specify-execute`](../../plugins/spec/skills/execute/SKILL.md) | `/spec:execute` (no argument-hint; loop semantics documented in body) | [`acceptance/lifecycle/cross-repo-contract-flow.md`](../../acceptance/lifecycle/cross-repo-contract-flow.md) (`execute-loop-all-done`) | [`acceptance/examples/skills/execute/*/`](../../acceptance/examples/skills/execute/) | ✓ | Cross-repo scenario asserts the loop terminates; fixture docs preserve `input/plan.yaml` + `expected.md` examples for breakout, build-failure, and workspace cases. |
| [`specify-plan`](../../plugins/spec/skills/plan/SKILL.md) | `<change-name>` | [`acceptance/lifecycle/plan-single-project.md`](../../acceptance/lifecycle/plan-single-project.md), [`acceptance/lifecycle/contract-routing.md`](../../acceptance/lifecycle/contract-routing.md), [`acceptance/lifecycle/cross-repo-contract-flow.md`](../../acceptance/lifecycle/cross-repo-contract-flow.md) | -- | ✓ | Single-project covers local-only plans; contract-routing covers cross-repo plan authoring; cross-repo-contract-flow.md drives the full plan → execute → finalize path. |
...
- Acknowledge that `tests/scenarios/*.json` does not exist; the brief should
  call out `acceptance/lifecycle/*.md`, `acceptance/lifecycle/cross-repo-contract-flow.md`, and
