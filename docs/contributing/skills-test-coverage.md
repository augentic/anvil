...
[`acceptance/fixtures/{sources,targets,skills}/`](../../acceptance/fixtures/) document
...
| `specify-extract` (retired; logic lifted into per-source `extract` briefs invoked by `/spec:refine`) | `<source-path> <slice-dir>` (now a sub-step of `/spec:refine`) | -- | [`source.md`](../../adapters/targets/contracts/tests/source.md), [`acceptance/fixtures/sources/{intent,documentation,code-typescript,screenshots}/`](../../acceptance/fixtures/sources/) | ✓ | The `contracts-source` scenario asserts artifacts derived from source code; source fixtures preserve representative Evidence goldens for future executable replay. |
...
| [`specify-merge`](../../plugins/spec/skills/merge/SKILL.md) | `[slice-name]` | [`acceptance/lifecycle/cross-repo-contract-flow.md`](../../acceptance/lifecycle/cross-repo-contract-flow.md) | [`describe.md`](../../adapters/targets/contracts/tests/describe.md), [`design.md`](../../adapters/targets/contracts/tests/design.md), [`update.md`](../../adapters/targets/contracts/tests/update.md), [`import.md`](../../adapters/targets/contracts/tests/import.md), [`source.md`](../../adapters/targets/contracts/tests/source.md), [`acceptance/fixtures/skills/merge/`](../../acceptance/fixtures/skills/merge/) | partial | Reached through `stages: [refine, build, merge]`; fixture docs preserve `success` and `conflict-replay` shapes. No scenario targets merge in isolation against a live LLM body. |
| [`specify-finalize`](../../plugins/spec/skills/finalize/SKILL.md) | `<change-name>` | [`acceptance/lifecycle/cross-repo-contract-flow.md`](../../acceptance/lifecycle/cross-repo-contract-flow.md) | [`acceptance/fixtures/skills/finalize/`](../../acceptance/fixtures/skills/finalize/) | ✓ | Cross-repo scenario drives finalize end-to-end; fixture docs preserve single-repo and multi-project-workspace transcripts. |
