...
- **Skills:** every `plugins/<plugin>/skills/<skill>/SKILL.md` and the
  ...
  trigger).
- **Plan-generation scenarios:** [`acceptance/scenarios/`](../../acceptance/scenarios/) -- two
  manual scenarios that cover plan authoring only (no execution, no push, no
  finalize).
- **Cross-repo scenarios:** [`acceptance/scenarios/`](../../acceptance/scenarios/) --
...
| --- | --- | --- | --- | --- | --- |
| [`specify-execute`](../../plugins/spec/skills/execute/SKILL.md) | `/spec:execute` (no argument-hint; loop semantics documented in body) | [`acceptance/scenarios/cross-repo-contract-flow.md`](../../acceptance/scenarios/cross-repo-contract-flow.md) (`execute-loop-all-done`) | [`acceptance/fixtures/skills/execute/*/`](../../acceptance/fixtures/skills/execute/) | ✓ | Cross-repo scenario asserts the loop terminates; fixture docs preserve `input/plan.yaml` + `expected.md` examples for breakout, build-failure, and workspace cases. |
| [`specify-plan`](../../plugins/spec/skills/plan/SKILL.md) | `<change-name>` | [`acceptance/scenarios/plan-single-project.md`](../../acceptance/scenarios/plan-single-project.md), [`acceptance/scenarios/contract-routing.md`](../../acceptance/scenarios/contract-routing.md), [`acceptance/scenarios/cross-repo-contract-flow.md`](../../acceptance/scenarios/cross-repo-contract-flow.md) | -- | ✓ | Single-project covers local-only plans; contract-routing covers cross-repo plan authoring; cross-repo-contract-flow.md drives the full plan → execute → finalize path. |
...
- Acknowledge that `tests/scenarios/*.json` does not exist; the brief should
  call out `acceptance/scenarios/*.md`, `acceptance/scenarios/cross-repo-contract-flow.md`, and
