...
- **Adapter-local scenarios:**
  [`adapters/contracts/tests/`](../../adapters/contracts/tests/) --
...
| [`contract-json-schema`](../../plugins/contract/skills/json-schema/SKILL.md) | `[slice-dir]` (standalone JSON Schema) | -- | [`describe.md`](../../adapters/contracts/tests/describe.md), [`design.md`](../../adapters/contracts/tests/design.md), [`update.md`](../../adapters/contracts/tests/update.md), [`import.md`](../../adapters/contracts/tests/import.md), [`source.md`](../../adapters/contracts/tests/source.md) | ✓ | Every contracts scenario asserts `contracts/schemas/*.yaml` artifacts and runs `contract-validator-clean`. |
| [`contract-openapi`](../../plugins/contract/skills/openapi/SKILL.md) | `[slice-dir]` (OpenAPI 3.1) | -- | [`describe.md`](../../adapters/contracts/tests/describe.md), [`design.md`](../../adapters/contracts/tests/design.md), [`update.md`](../../adapters/contracts/tests/update.md), [`import.md`](../../adapters/contracts/tests/import.md), [`source.md`](../../adapters/contracts/tests/source.md) | ✓ | Every contracts scenario asserts `contracts/http/*.yaml` artifacts. |
...
| [`change-analyze`](../../plugins/change/skills/analyze/SKILL.md) | `<input-path> <output-dir>` | [`tests/plan/single-project.md`](../../tests/plan/single-project.md), [`tests/plan/contract-routing.md`](../../tests/plan/contract-routing.md) | -- | partial | Plan scenarios assert `discovery.md` exists; analyze is invoked as a sub-step of the planning brief pipeline but no scenario invokes `/change:analyze` directly with a `kind` positional. |
| [`specify-build`](../../plugins/spec/skills/build/SKILL.md) | `[slice-name]` | [`tests/cross-repo/scenario.md`](../../tests/cross-repo/scenario.md) | [`describe.md`](../../adapters/contracts/tests/describe.md), [`design.md`](../../adapters/contracts/tests/design.md), [`update.md`](../../adapters/contracts/tests/update.md), [`import.md`](../../adapters/contracts/tests/import.md), [`source.md`](../../adapters/contracts/tests/source.md) | partial | All scenarios with `stages: [define, build, merge]` reach build, but none target build-only resumption (`/spec:build <slice-name>` after a partial run). |
| [`specify-define`](../../plugins/spec/skills/define/SKILL.md) | `[description]` | [`tests/cross-repo/scenario.md`](../../tests/cross-repo/scenario.md) | [`describe.md`](../../adapters/contracts/tests/describe.md), [`design.md`](../../adapters/contracts/tests/design.md), [`update.md`](../../adapters/contracts/tests/update.md), [`import.md`](../../adapters/contracts/tests/import.md), [`source.md`](../../adapters/contracts/tests/source.md) | ✓ | Every contracts scenario uses `entrypoint: /spec:define`; cross-repo drives define inside its execute loop. |
...
| [`specify-extract`](../../plugins/spec/skills/extract/SKILL.md) | `<source-path> <slice-dir>` | -- | [`source.md`](../../adapters/contracts/tests/source.md) | ✓ | The `contracts-source` scenario uses `authorship-mode: extract` and asserts artifacts derived from source code; coverage is scoped to the contracts adapter only. |
...
| [`specify-merge`](../../plugins/spec/skills/merge/SKILL.md) | `[slice-name]` | [`tests/cross-repo/scenario.md`](../../tests/cross-repo/scenario.md) | [`describe.md`](../../adapters/contracts/tests/describe.md), [`design.md`](../../adapters/contracts/tests/design.md), [`update.md`](../../adapters/contracts/tests/update.md), [`import.md`](../../adapters/contracts/tests/import.md), [`source.md`](../../adapters/contracts/tests/source.md) | partial | Reached through `stages: [define, build, merge]`; no scenario targets merge in isolation or asserts the archive transition that `/spec:merge` performs. |
...
| [`contract-asyncapi`](../../plugins/contract/skills/asyncapi/SKILL.md) | No AsyncAPI scenario. | Sister scenario to `adapters/contracts/tests/describe.md` that requests an evented contract (channels, messages, bindings) and asserts `contracts/asyncapi/*.yaml` plus `contract-validator-clean`. |
...
| [`change-analyze`](../../plugins/change/skills/analyze/SKILL.md) | Reached only via plan pipeline. | Direct invocation scenario: `/change:analyze <input-path> <output-dir>` against (a) a documentation tree and (b) a code tree, asserting the emitted adapter summaries differ on the `kind` positional and that `discovery.md` is structured per the schema. |
...
| [`vectis-core-reviewer`](../../plugins/vectis/skills/core-reviewer/SKILL.md) | No core review scenario. | Fixture core review scenario asserting structural findings (module boundaries, adapter typings, ViewModel/Effect pairing). |
| [`vectis-core-writer`](../../plugins/vectis/skills/core-writer/SKILL.md) | Reached but not asserted. | Targeted scenario asserting the Rust shared crate is produced for a known slice (Cargo manifest, `src/app.rs`, adapter wiring, uniffi exports). |
