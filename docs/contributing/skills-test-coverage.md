...
| [`specify-plan`](../../plugins/spec/skills/plan/SKILL.md) | `<change-name>` | [`evals/scenarios/single-project-plan.md`](../../evals/scenarios/single-project-plan.md), contract-routing deterministic coverage ([`tests/workflow/propose.rs`](../../engine/tests/workflow/propose.rs), [`tests/plan/end_to_end.rs`](../../engine/tests/plan/end_to_end.rs)), [`evals/scenarios/contract-lifecycle.md`](../../evals/scenarios/contract-lifecycle.md) | -- | ✓ | Single-project covers local-only plans; contract-routing covers cross-repo plan authoring; contract-lifecycle.md drives the full plan → execute → finalize path. |
...
| `change-analyze` (plan-time source survey inlined into `/spec:plan`) | n/a — inlined into `/spec:plan` | [`evals/scenarios/single-project-plan.md`](../../evals/scenarios/single-project-plan.md), contract-routing deterministic coverage ([`tests/workflow/propose.rs`](../../engine/tests/workflow/propose.rs), [`tests/plan/end_to_end.rs`](../../engine/tests/plan/end_to_end.rs)) | -- | partial | Plan scenarios assert `discovery.md` exists; per-source survey is a sub-step of `/spec:plan` and is not invocable as a standalone slash command. |
...
| [`specify-init`](../../plugins/spec/skills/init/SKILL.md) | `<target>` (or `workspace`) | [`evals/scenarios/single-project-plan.md`](../../evals/scenarios/single-project-plan.md), contract-routing deterministic coverage ([`tests/workflow/propose.rs`](../../engine/tests/workflow/propose.rs), [`tests/plan/end_to_end.rs`](../../engine/tests/plan/end_to_end.rs)), [`evals/scenarios/contract-lifecycle.md`](../../evals/scenarios/contract-lifecycle.md) | -- | ✓ | Single-project covers `specify init <target>`; contract-routing and cross-repo cover both `--workspace` and target-bound init. |
