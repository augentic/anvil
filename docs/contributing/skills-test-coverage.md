...
> them. The retired legacy verbs (`change-*`, `specify-define`, `specify-extract`,
...
> renamed verbs. Per-replay coverage is tracked alongside the manual
> scenarios.
...
[`acceptance/examples/{sources,targets,skills}/`](../../acceptance/examples/) document
...
[`acceptance/suites/lifecycle/`](../../acceptance/suites/lifecycle/) and
[`acceptance/suites/lifecycle/`](../../acceptance/suites/lifecycle/) cover the LLM-driven body bytes that the
...
- **Skills:** every `plugins/<plugin>/skills/<skill>/SKILL.md` and the
  ...
  trigger).
- **Plan-generation scenarios:** [`acceptance/suites/lifecycle/`](../../acceptance/suites/lifecycle/) -- two
  manual scenarios that cover plan authoring only (no execution, no push, no
  finalize).
- **Cross-repo scenarios:** [`acceptance/suites/lifecycle/`](../../acceptance/suites/lifecycle/) --
...
> **Scenario fixtures (`acceptance/suites/**/*.json`).** The cleanup-plan brief
...
- **Primary trigger** -- the `argument-hint` from the skill's frontmatter, or
  ...
  `argument-hint`.
- **Plan trace(s)** -- markdown scenarios under `acceptance/suites/lifecycle/` or
  `acceptance/suites/lifecycle/` that exercise this skill (directly or as a documented
...
| --- | --- | --- | --- | --- | --- |
| [`specify-execute`](../../plugins/spec/skills/execute/SKILL.md) | `/spec:execute` (no argument-hint; loop semantics documented in body) | [`acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md`](../../acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md) (`execute-loop-all-done`) | [`acceptance/examples/skills/execute/*/`](../../acceptance/examples/skills/execute/) | ✓ | Cross-repo scenario asserts the loop terminates; fixture docs preserve `input/plan.yaml` + `expected.md` examples for breakout, build-failure, and workspace cases. |
| [`specify-plan`](../../plugins/spec/skills/plan/SKILL.md) | `<change-name>` | [`acceptance/suites/lifecycle/plan-single-project/scenario.md`](../../acceptance/suites/lifecycle/plan-single-project/scenario.md), [`acceptance/suites/lifecycle/contract-routing/scenario.md`](../../acceptance/suites/lifecycle/contract-routing/scenario.md), [`acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md`](../../acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md) | -- | ✓ | Single-project covers local-only plans; contract-routing covers cross-repo plan authoring; cross-repo/scenario.md drives the full plan → execute → finalize path. |
...
| [`contract-asyncapi`](../../adapters/targets/contracts/briefs/build.md#asyncapi-sub-flow) | `[slice-dir]` (AsyncAPI authoring) | -- | -- | gap | All five contract scenarios author HTTP/JSON-Schema artifacts; none produce an AsyncAPI document. |
| [`contract-json-schema`](../../adapters/targets/contracts/briefs/build.md#json-schema-sub-flow) | `[slice-dir]` (standalone JSON Schema) | -- | [`describe.md`](../../adapters/targets/contracts/tests/describe.md), [`design.md`](../../adapters/targets/contracts/tests/design.md), [`update.md`](../../adapters/targets/contracts/tests/update.md), [`import.md`](../../adapters/targets/contracts/tests/import.md), [`source.md`](../../adapters/targets/contracts/tests/source.md) | ✓ | Every contracts scenario asserts `contracts/schemas/*.yaml` artifacts and runs `contract-validator-clean`. |
| [`contract-openapi`](../../adapters/targets/contracts/briefs/build.md#openapi-sub-flow) | `[slice-dir]` (OpenAPI 3.1) | -- | [`describe.md`](../../adapters/targets/contracts/tests/describe.md), [`design.md`](../../adapters/targets/contracts/tests/design.md), [`update.md`](../../adapters/targets/contracts/tests/update.md), [`import.md`](../../adapters/targets/contracts/tests/import.md), [`source.md`](../../adapters/targets/contracts/tests/source.md) | ✓ | Every contracts scenario asserts `contracts/http/*.yaml` artifacts. |
| `omnia` target — `build` brief ([`adapters/targets/omnia/briefs/build.md`](../../adapters/targets/omnia/briefs/build.md)) | crate / test / guest writers + code reviewer, run by `/spec:build` | [`acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md`](../../acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md) | -- | partial | Cross-repo's backend slice routes to an `omnia@v1` project so the build brief is reached during `/spec:execute`, but no assertion targets the produced crate, tests, guest, or review output (only `execute-loop-all-done`). The bodies of the retired `omnia-{crate,test,guest}-writer` and `omnia-code-reviewer` skills live inside this brief; gap coverage from previous releases (no scenario reviews / asserts generated artifacts) is preserved by this row. |
...
| `change-analyze` (retired; plan-time source survey inlined into `/spec:plan`) | n/a — inlined into `/spec:plan` | [`acceptance/suites/lifecycle/plan-single-project/scenario.md`](../../acceptance/suites/lifecycle/plan-single-project/scenario.md), [`acceptance/suites/lifecycle/contract-routing/scenario.md`](../../acceptance/suites/lifecycle/contract-routing/scenario.md) | -- | partial | Plan scenarios assert `discovery.md` exists; per-source survey is a sub-step of `/spec:plan` and is not invocable as a standalone slash command. |
| [`specify-build`](../../plugins/spec/skills/build/SKILL.md) | `[slice-name]` | [`acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md`](../../acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md) | [`describe.md`](../../adapters/targets/contracts/tests/describe.md), [`design.md`](../../adapters/targets/contracts/tests/design.md), [`update.md`](../../adapters/targets/contracts/tests/update.md), [`import.md`](../../adapters/targets/contracts/tests/import.md), [`source.md`](../../adapters/targets/contracts/tests/source.md), [`acceptance/examples/skills/build/`](../../acceptance/examples/skills/build/) | partial | All scenarios with `stages: [refine, build, merge]` reach build; fixture docs preserve `success`, `breakout-from-execute`, and `failure-replay` shapes. No scenario targets build-only resumption against a live LLM body. |
| [`specify-refine`](../../plugins/spec/skills/refine/SKILL.md) | n/a — orchestrates `extract` per source | [`acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md`](../../acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md) | [`describe.md`](../../adapters/targets/contracts/tests/describe.md), [`design.md`](../../adapters/targets/contracts/tests/design.md), [`update.md`](../../adapters/targets/contracts/tests/update.md), [`import.md`](../../adapters/targets/contracts/tests/import.md), [`source.md`](../../adapters/targets/contracts/tests/source.md), [`acceptance/examples/skills/refine/`](../../acceptance/examples/skills/refine/) | ✓ | Every contracts scenario uses `entrypoint: /spec:refine`; cross-repo drives refine inside its `/spec:execute` loop; fixture docs preserve Evidence inputs and synthesised `expected/spec.md` examples across `single-source-intent`, `combined-docs-and-legacy`, `conflict`, `divergence`, and `unknown` cases. |
...
| `specify-extract` (retired; logic lifted into per-source `extract` briefs invoked by `/spec:refine`) | `<source-path> <slice-dir>` (now a sub-step of `/spec:refine`) | -- | [`source.md`](../../adapters/targets/contracts/tests/source.md), [`acceptance/examples/sources/{intent,documentation,code-typescript,screenshots}/`](../../acceptance/examples/sources/) | ✓ | The `contracts-source` scenario asserts artifacts derived from source code; source fixtures preserve representative Evidence goldens for future executable replay. |
| [`specify-init`](../../plugins/spec/skills/init/SKILL.md) | `<target>` (or `workspace`) | [`acceptance/suites/lifecycle/plan-single-project/scenario.md`](../../acceptance/suites/lifecycle/plan-single-project/scenario.md), [`acceptance/suites/lifecycle/contract-routing/scenario.md`](../../acceptance/suites/lifecycle/contract-routing/scenario.md), [`acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md`](../../acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md) | -- | ✓ | Single-project covers `specify init <target>`; contract-routing and cross-repo cover both `--workspace` and target-bound init. |
| [`specify-merge`](../../plugins/spec/skills/merge/SKILL.md) | `[slice-name]` | [`acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md`](../../acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md) | [`describe.md`](../../adapters/targets/contracts/tests/describe.md), [`design.md`](../../adapters/targets/contracts/tests/design.md), [`update.md`](../../adapters/targets/contracts/tests/update.md), [`import.md`](../../adapters/targets/contracts/tests/import.md), [`source.md`](../../adapters/targets/contracts/tests/source.md), [`acceptance/examples/skills/merge/`](../../acceptance/examples/skills/merge/) | partial | Reached through `stages: [refine, build, merge]`; fixture docs preserve `success` and `conflict-replay` shapes. No scenario targets merge in isolation against a live LLM body. |
| [`specify-finalize`](../../plugins/spec/skills/finalize/SKILL.md) | `<change-name>` | [`acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md`](../../acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md) | [`acceptance/examples/skills/finalize/`](../../acceptance/examples/skills/finalize/) | ✓ | Cross-repo scenario drives finalize end-to-end; fixture docs preserve single-repo and multi-project-workspace transcripts. |
| `vectis` target — `build` brief ([`adapters/targets/vectis/briefs/build.md`](../../adapters/targets/vectis/briefs/build.md)) | core / test / iOS / Android writers + reviewers + template-updater, run by `/spec:build` | [`acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md`](../../acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md) | -- | partial | Cross-repo's mobile slice routes to a `vectis@v1` project so the build brief is reached during `/spec:execute`, but no assertion targets the produced Crux core, iOS / Android shells, generated tests, reviewer output, or template-drift recovery. The bodies of the retired `vectis-{core,test,ios,android}-writer`, `vectis-{core,ios,android}-reviewer`, and `vectis-template-updater` skills live inside this brief; gap coverage from previous releases (no scenario reviews / asserts generated artifacts, no template-drift scenario) is preserved by this row. |
| `vectis` target — `merge` brief ([`adapters/targets/vectis/briefs/merge.md`](../../adapters/targets/vectis/briefs/merge.md)) | host cap-matrix re-verification (`cargo` / `make build` / `gradlew`), run by `/spec:merge` | [`acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md`](../../acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md) | -- | partial | Reached as part of the mobile slice's `stages: [refine, build, merge]` chain; no scenario asserts the post-merge host-cap-matrix re-verification or the deferred-merge failure-mode handling. |

**Totals (15 live skill rows + 3 target-adapter rows; the retired `change-analyze` / `specify-extract` rows above are retained for their historical coverage notes and are not tallied as live skills)**
...
The four retired Omnia skills (`omnia-crate-writer`, `omnia-test-writer`, `omnia-guest-writer`, `omnia-code-reviewer`) collapsed into a single target-adapter `build` brief; they are tracked as one row above. The retired `capture-replay-writer` skill collapsed into the `captures` source adapter (survey/extract) plus Omnia `build/test.md` and `build/replay.md`. The eight retired Vectis skills (`vectis-{core,test,ios,android}-writer`, `vectis-{core,ios,android}-reviewer`, `vectis-template-updater`) collapsed into the target-adapter `build` brief; their Vectis-specific post-merge checks moved to the `merge` brief. The retired `vectis-image-layout-inferer` skill body moved to the [`screenshots` source adapter](../../adapters/sources/screenshots/adapter.yaml); its source-adapter coverage is exercised by the `acceptance/examples/sources/screenshots/` deterministic-boundary harness.
...
- Acknowledge that `tests/scenarios/*.json` does not exist; the brief should
  call out `acceptance/suites/lifecycle/**/scenario.md`, `acceptance/suites/lifecycle/cross-repo-contract-flow/scenario.md`, and
