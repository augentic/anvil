...
- **Failure and breakout** (`stepthrough-breakout`, `execute-build-failure`, `workspace-breakout`, `dual-driving-refused`, `stale-workspace-recovery`): build-failure stop/resume, breakout verbs, dual-driving refusal, and stale-slot recovery.
