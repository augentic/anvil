...
- [CLI Reference](cli/index.md) — all `specrun` subcommands grouped by family.
- [Declared Tool Helper Inventory](declared-tool-helper-inventory.md) — first-party helper migration boundary for `specrun tool run`.
