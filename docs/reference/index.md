...
- [Change Skills](change-skills/index.md) -- `/change:plan`, `/change:execute`, and `/change:analyze` for multi-slice changes; `/change:plan <name> orchestrate` for cross-repo changes end-to-end.
