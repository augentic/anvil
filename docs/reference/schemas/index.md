...
The Contracts schema uses a reduced pipeline: proposal, specs, contracts, tasks (no design or composition stages). Its build phase delegates to `/contracts:validator` rather than code-generation skills.
