...
|-------|------------------|
| [`build.md`](https://github.com/augentic/specify-adapters/blob/main/targets/contracts/briefs/build.md) | `json-schema`, `openapi`, and `asyncapi` (each with author / import / verify intents) |
...
- Rules under [`adapters/targets/contracts/rules/`](https://github.com/augentic/specify-adapters/tree/main/targets/contracts/rules/) for stable `IFACE-*` reviewer guidance on compatibility, versioning, and consumer-impact classification.
