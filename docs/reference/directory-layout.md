...
└── change/                                 # In-place change home (temporary; archived or deleted)
    ...
    ├── discovery.yaml                      # Reviewed handoff + pinned targets and sources
    ├── leads.md                            # Canonical lead catalog (no summary preamble)
