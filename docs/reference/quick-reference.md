...
specrun plan add <entry> --sources <key>=<lead-id> --target <adapter@vN> --project <name>
specrun plan amend <entry> --add-source <key>=<lead-id> --remove-source <key> --divergence accepted
