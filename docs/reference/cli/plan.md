...
- [Change skills](../change-skills/index.md) -- `/spec:plan` and `/spec:finalize` wrappers
- [`/spec:plan` skill body](../../../plugins/spec/skills/plan/SKILL.md)
- [`/spec:finalize` skill body](../../../plugins/spec/skills/finalize/SKILL.md)
