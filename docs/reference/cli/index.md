...
`/spec:init` installs or refreshes the CLI via `cargo binstall` (prebuilt). See [Prerequisites](../../orientation/prerequisites.md) for every install path and adapter-specific tooling.
