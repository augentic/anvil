...
```json
{
  ...
  "journaled": false,
  "commands": [
    { "program": "cargo", "args": ["install", "--git", "https://github.com/augentic/specify-cli", "--tag", "v0.43.0"] }
  ]
}
```
