...
For the full schema definition and item vocabulary, see the [Vectis composition schema](../../adapters/targets/vectis/schemas/composition.schema.json).
...
- `composition.yaml` conforms to the JSON Schema at `adapters/targets/vectis/schemas/composition.schema.json`
