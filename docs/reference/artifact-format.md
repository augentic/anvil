...
For the full schema definition and item vocabulary, see the [Vectis composition schema](https://schemas.specify.dev/vectis/composition.schema.json) (retrieve with `specify extension schema vectis composition`).
