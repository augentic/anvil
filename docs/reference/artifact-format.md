...
For the full schema definition and item vocabulary, see the [Vectis composition schema](../../targets/vectis/schemas/composition.schema.json).
...
- `composition.yaml` conforms to the JSON Schema at `targets/vectis/schemas/composition.schema.json`
