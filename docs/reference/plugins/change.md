...
| [`/change:analyze`](../change-skills/analyze.md) | Plan-time capability inference; emits capability summaries into `discovery.md` from legacy code or documentation inputs (invoked internally by `/change:draft`). |
