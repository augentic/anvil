...
- **Omnia target** drives crate, test, guest, and review phases inline from [`adapters/targets/omnia/briefs/build.md`](https://github.com/augentic/specify-adapters/blob/main/adapters/targets/omnia/briefs/build.md).
