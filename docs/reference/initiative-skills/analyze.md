...
Typically invoked by the discovery phase during `/spec:plan`, not directly. Reads one input and appends capability summaries to `discovery.md`.
...
- [/spec:plan](plan.md) -- the primary consumer of analyze
- [/spec:extract](../change-skills/extract.md) -- the deep counterpart at define time
