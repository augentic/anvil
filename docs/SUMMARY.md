...
- [CLI reference](reference/cli/index.md)
  ...
  - [specify compatibility](reference/cli/compatibility.md)
...
- [Target adapters](reference/adapters/index.md)
  - [Omnia](reference/adapters/omnia.md)
  - [Vectis](reference/adapters/vectis.md)
  - [Contracts](reference/adapters/contracts.md)
