...
- [Change Skills (Layer 2)](reference/change-skills/index.md)
  - [/spec:init](reference/change-skills/init.md)
  - [/spec:define](reference/change-skills/define.md)
  - [/spec:build](reference/change-skills/build.md)
  - [/spec:merge](reference/change-skills/merge.md)
...
- [Initiative Skills (Layers 3 & 4)](reference/initiative-skills/index.md)
  - [/change:plan --orchestrate](reference/initiative-skills/initiative.md)
  - [/change:plan](reference/initiative-skills/plan.md)
  - [/change:execute](reference/initiative-skills/execute.md)
