...
The `style` doc lints (see [Comments](#comments)) catch the mechanical density caps. The `ident_length` lint (see [Naming](#naming)) catches the 25-character identifier cap on items, fields, and variants.
