...
- Scripted model answers live in `testkit::answers` as the single shared copy the suites consume; keep them concise and structural, not a scenario format.
