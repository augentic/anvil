...
- **Phase 2.1 – 2.4 (specify side):** committed on `rfc-11-phase2` (also pushed to `origin/rfc-11-phase2`); not yet PR'd as of Phase 2.5's authoring. The cluster is the natural unit to PR after Phase 2.5 commits.
- **Phase 2.5 (specify side):** authored against `rfc-11-phase2` but uncommitted at the moment Phase 2.5's status note was drafted; the user commits and PRs at their option.
