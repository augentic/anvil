...
| File | Component |
| ---- | --------- |
| [`hero.md`](hero.md) | Top-of-chapter hero with meta chips |

For additional patterns (decisions, rhythm cards, platform strip), copy from the exemplar pages listed in doc-authoring.
