...
Scope: the in-tree Rust workspace at the repo root (primary) and the surrounding `augentic/specify` prose (CORE rule files, docs).
...
- [adapters/shared/prose/rules/core/README.md](https://github.com/augentic/specify/blob/main/adapters/shared/prose/rules/core/README.md) (framework repo)
...
| CORE rule authoring | specify | [adapters/shared/prose/rules/core/README.md](https://github.com/augentic/specify/blob/main/adapters/shared/prose/rules/core/README.md) |
| Declarative CORE rules | specify | `adapters/shared/prose/rules/core/CORE-*.md` |
