...
#[test]
fn generated_files_match_derivation() {
...
#[test]
fn derived_schemas_compile_standalone() {
    for (name, derived) in [
        ("leads", answers::leads()),
...
#[test]
fn answer_enums_match_wit_contract() {
...
#[test]
fn evidence_answer_strips_lead() {
...
/// finding.
#[test]
fn report_answer_strips_envelope() {
