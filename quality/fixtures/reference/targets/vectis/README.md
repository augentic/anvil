# `quality/fixtures/reference/targets/vectis/`
...
- [`adapters/targets/vectis/prose/briefs/shape.md`](https://github.com/augentic/specify-adapters/blob/main/targets/vectis/prose/briefs/shape.md) — the idiom guidance each fixture's `input/` reflects.
- [`adapters/targets/vectis/prose/briefs/build.md`](https://github.com/augentic/specify-adapters/blob/main/targets/vectis/prose/briefs/build.md) — the orchestration each fixture's `expected/composition.yaml` reflects.
- [`quality/fixtures/reference/sources/screenshots/task-list-two-screen/`](../../sources/screenshots/task-list-two-screen/) — the matching source-side fixture whose `expected/evidence/` feeds these fixtures' `input/evidence/`.
- [`target-shape` runbook](../../../../runbooks/target-shape.md) and the [quality-profile entry point](../../../../../docs/contributing/quality-profiles.md).
