...
3. Run `specify slice build password-hash-rotate --phase prepare --format json`, then read and execute the handoff's `adapters/targets/omnia/prose/briefs/build.md` linearly.
