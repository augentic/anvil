...
Distributed working trees, verify profiles, and managed workspace slots are no longer deferred: they are steps 2 and 3 of the platform-migration series — [RFC-86](rfc-86-working-trees.md) and [RFC-87](rfc-87-verify-profiles.md), following [RFC-85](rfc-85-migration-program.md); see [next-stage.md](next-stage.md) for the full sequence.
