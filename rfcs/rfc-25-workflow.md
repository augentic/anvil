...
3. `[divergence]` override seam? **Preference:** edit `spec.md` in v1.
4. Slice dir at `plan add` vs extract start? **Preference:** at extract (Gate 1 plan-pure).
5. Lifecycle wire format? **Preference:** snake_case.
