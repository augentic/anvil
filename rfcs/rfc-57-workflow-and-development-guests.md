...
1. Run the workflow as a guest on the RFC-55 runtime with **every** phase still agent-driven behind `judge` — the no-compile baseline that proves the move without ossifying anything.
