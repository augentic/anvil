...
| **D9 Adapter execution**               | Source and target adapters declare a closed `execution: executable                                                                                                                                                                                                                                     | agent-fallback`field selecting deterministic dispatch vs an agent-run brief. |
| **D10 Synthesis execution**            | The synthesis step carries a closed `execution: agent                                                                                                                                                                                                                                                  | executable` enum; agent-first by design.                                            |
