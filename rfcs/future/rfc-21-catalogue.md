...
`additionalProperties: false` everywhere; `serde(deny_unknown_fields)` in the Rust parser, mirroring [`Registry`](../../crates/workflow-lib/src/registry/catalog.rs). Duplicate `key` values fail validation. Kebab-case violations fail validation.
...
- [`engine/crates/workflow-lib/src/registry/catalog.rs`](../../crates/workflow-lib/src/registry/catalog.rs) — reference implementation for the `Registry` posture `Sources` mirrors.
