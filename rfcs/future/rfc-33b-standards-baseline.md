...
The principles that govern this layer are stated in full in [RFC-33a](https://github.com/augentic/specify-cli/blob/main/DECISIONS.md#lint-finding-status-disposition-and-exit) §"Principles". RFC-33b activates the two that were dormant while it was deferred:
...
The decision IDs (D1, D2, D7, D9, D10, D11) are preserved from the original combined RFC-33 so prior references continue to resolve. [RFC-33a](https://github.com/augentic/specify-cli/blob/main/DECISIONS.md#lint-finding-status-disposition-and-exit) owns D3, D4, D5, D6, D8, D12, D13.
...
Q1, Q2, and Q4 from earlier drafts have been resolved into normative decisions D10, D11, and D12 (the last lives in [RFC-33a](https://github.com/augentic/specify-cli/blob/main/DECISIONS.md#lint-finding-status-disposition-and-exit)) respectively.

## References

- RFC-28: Engineering Standards — Codex Contract and Findings — [`DECISIONS.md` §Diagnostic substrate](https://github.com/augentic/specify-cli/blob/main/DECISIONS.md#drained-errorvalidation-and-the-diagnostic-substrate)
- RFC-32: Engineering Standards — Deterministic Enforcement — [`DECISIONS.md` §Standards layer split](https://github.com/augentic/specify-cli/blob/main/DECISIONS.md#standards-layer-split-into-specify-standards-and-specify-schema)
- RFC-33a: Standards Ignore Directives — [`DECISIONS.md` §Lint finding lifecycle](https://github.com/augentic/specify-cli/blob/main/DECISIONS.md#lint-finding-status-disposition-and-exit) — companion to this RFC; provides the wire-shape decisions consumed here
