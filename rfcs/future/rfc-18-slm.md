...
> Status: Draft - Depends: [RFC-28](../done/rfc-28-standards-contract.md), [RFC-32](../rfc-32-standards-enforcement.md), [RFC-10](../done/rfc-10-skills.md), [RFC-13](../done/rfc-13-extensibility.md)
