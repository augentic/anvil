...
> Status: Draft - Depends: [RFC-28](../next/rfc-28-codex-rules.md), [RFC-10](../done/rfc-10-skills.md), [RFC-13](../done/rfc-13-extensibility.md)
...
- [RFC-28: Codex Resolution and Structured Review Findings](../next/rfc-28-codex-rules.md)
