...
> Status: Draft - Depends: RFC-28, RFC-32, RFC-10, and RFC-13 (durable enforcement spec in [`engine/DECISIONS.md`](../../engine/DECISIONS.md)) - Architecture: the SLM member of the [RFC-56](../rfc-56-infer-fleet.md) `infer` fleet — enabled by the fleet, gating nothing (a ratchet rung, not a stage)
