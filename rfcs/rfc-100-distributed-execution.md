...
>
> Depends on completed [RFC-86](rfc-86-change-facts.md), [RFC-87](rfc-87-working-trees.md), [RFC-88](rfc-88-detached-changes.md), [RFC-90](rfc-90-build-verification.md), [RFC-91](rfc-91-refinement-stage.md), and [RFC-96](rfc-96-concurrent-execution.md). RFC-96 owns `(slice, phase, input-digest)` readiness and local operation claims; this RFC distributes those identities through offers, leases, ownership generations, and stale-result rejection.
>
