...
- **Sequencing.** RFC-63 (hydration, generated manifest) is a prerequisite; RFC-66's `specify:core` publish job can land inert ahead of the cut, and its registry and tap work is orthogonal and may land first. The optional embed rides Omnia's timetable without blocking anything.
