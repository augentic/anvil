...
> Status: Superseded by [RFC-91 Concurrent Execution](../rfc-91-concurrent-execution.md) D7–D10, which merges this RFC's refine-time redesign with RFC-79's build-time swarm. Retained for the original measurement and sequencing detail.
>
