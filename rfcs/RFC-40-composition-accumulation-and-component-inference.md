...
1. Run `specify catalog infer --phase report` against the current baseline (plus the candidate cache and `parts.yaml`) to obtain the deterministic cluster report.
