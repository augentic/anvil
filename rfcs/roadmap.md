...
**Depends:** [RFC-29](rfc-29-fan-in-fan-out.md) (typed slice model, per-slice fan-out via `depends-on`); [RFC-28](done/rfc-28-standards-contract.md) / [RFC-32](done/rfc-32-standards-enforcement.md) (`IFACE-*` contract findings).
