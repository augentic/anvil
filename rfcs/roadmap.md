...
**Depends:** the [bootstrap/upgrade lifecycle](https://github.com/augentic/specify/blob/main/cli/DECISIONS.md#bootstrap-and-upgrade-lifecycle) for adoption at scale.
