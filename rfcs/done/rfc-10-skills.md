...
The check follows the existing `scripts/checks.ts` pattern; once [RFC-5](../rfc-5-tooling.md) lands, it migrates into `tooling check` alongside the other framework invariants.
