...
**Capture-backed verification.** For changes where the `wiretapper` has captured runtime request/response data from the legacy system, the replay flow generates tests from the captured scenarios and the build phase verifies the new implementation against them. This creates a behavioural regression safety net.
...
| Capture runtime captures        | Exists | `wiretapper`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
