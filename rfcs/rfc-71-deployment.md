...
>
> Builds on: [Emery on Omnia](architecture.md). Program: RFCs 70–72. Install transport: [RFC-76](archive/rfc-76-adapter-install.md) (archived).
...
- Selecting which adapters a project should use ([RFC-70](rfc-70-program.md))
